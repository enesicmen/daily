package com.icmen.daily.ui.activity
...
class MainActivity : AppCompatActivity() {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.menu_item_basket -> {
                    navigateToDestination(R.id.addDailyPageFragment)
                    true
                }
    ...
    private fun updateBottomNavigationView() {
        when (navController.currentDestination?.id) {
            ...
            R.id.addDailyPageFragment -> bottomNavigationView.selectedItemId = R.id.menu_item_basket
